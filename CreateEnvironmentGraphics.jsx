...
// SVG logo file
var logoWidth = prompt ("Please enter logo file width in pixels ", "991");
var logoHeight = prompt ("Please enter logo file width in pixels ", "165");
...
//EXAMPLES
Create(1536, 2048, "-MiddleCenter.png", "MiddleCenter", 40)
Create(1536, 2048, "-MiddleLeft.png", "MiddleLeft", 40)
Create(1536, 2048, "-MiddleRight.png", "MiddleRight", 40)
Create(1536, 2048, "-TopLeft.png", "TopLeft", 40)
Create(1536, 2048, "-TopRight.png", "TopRight", 40)
Create(1536, 2048, "-TopCenter.png", "TopCenter", 40)
Create(1536, 2048, "-BottomLeft.png", "BottomLeft", 40)
Create(1536, 2048, "-BottomCenter.png", "BottomCenter", 40)
Create(1536, 2048, "-BottomRight.png", "BottomRight", 40)
...
Create(1536, 2048, "background-1536x2048.png", "BottomCenter", 100)
Create(1536, 2048, "iPadBackground@2x-portrait.png", "BottomCenter", 100)
Create(1440, 2560, "background-1440x2560.png", "BottomCenter", 100)
Create(1242, 2208, "background-1242x2208.png", "BottomCenter", 100)
Create(1125, 2201, "background-1125x2001.png", "BottomCenter", 100)
Create(1080, 1920, "background-1080x1920.png", "BottomCenter", 100)
Create(768, 1024, "background-768x1024.png", "BottomCenter", 40)
Create(768, 1024, "ipadBackground-768x1024.png", "BottomCenter", 40)
Create(768, 1024, "ipadBackground-portrait.png", "BottomCenter", 40)
Create(750, 1334, "background-750x1334.png", "BottomCenter", 40)
Create(720, 1280, "background-720x1280.png", "BottomCenter", 40)
Create(720, 960, "background-720x960.png", "BottomCenter", 40)
Create(640, 1136, "background-640x1136.png", "BottomCenter", 40)
Create(640, 960, "background-640x960.png", "BottomCenter", 40)
Create(640, 960, "iphoneBackground-640px.png", "BottomCenter", 40)
Create(600, 1024, "background-600x1024.png", "BottomCenter", 40)
Create(480, 800, "background-480x800.png", "BottomCenter", 40)
Create(320, 480, "background-320x480.png", "BottomCenter", 100)
Create(1242, 2688, "background-1242x2688.png", "BottomCenter", 100)
Create(1125, 2436, "background-1125x2436.png", "BottomCenter", 40)
Create(828, 1792, "background-828x1792.png", "BottomCenter", 40)
Create(2048, 2732, "background-2048x2732.png", "BottomCenter", 100)
Create(1668, 2388, "background-1668x2388.png", "BottomCenter", 100)
Create(1668, 2224, "background-1668x2224.png", "BottomCenter", 100)



//BACKGROUNDS LANDSCAPES
Create(2208, 1242, "background-2208x1242.png", "BottomCenter", 100)
Create(2048,1536, "background-2048x1536.png", "BottomCenter", 100)
Create(2048, 1536, "iPadBackground@2x-landscape.png", "BottomCenter", 100)
Create(1920, 1080, "background-1920x1080.png", "BottomCenter", 100)
Create(1280, 720, "background-1280x720.png", "BottomCenter", 100)
Create(1024, 768, "background-1024x768.png", "BottomCenter", 100)
Create(1024, 768, "ipadBackground-1024x768.png", "BottomCenter", 100)
Create(1024, 768, "ipadBackground-landscape.png", "BottomCenter", 100)
Create(1024, 600, "background-1024x600.png", "BottomCenter", 40)
Create(960, 640, "background-960x640.png", "BottomCenter", 40)
Create(800, 480, "background-800x480.png", "BottomCenter", 40)
Create(480, 320, "background-480x320.png", "BottomCenter", 40)
Create(2732, 2048, "background-2732x2048.png", "BottomCenter", 100)
Create(2388, 1668, "background-2388x1668.png", "BottomCenter", 100)
Create(2224, 1668, "background-2224x1668.png", "BottomCenter", 100)
